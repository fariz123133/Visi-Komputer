...
# Konfigurasi
# -----------------------------
MODE = "pushup"  # Tekan 'm' untuk toggle ke "pushup"
KNEE_DOWN, KNEE_UP = 80, 160       # Ambang squat (derajat)
...
# -----------------------------
# Fungsi bantu: hitung rasio push-up
# -----------------------------
def ratio_pushup(lm):
...
while True:
    ...
    if lmList:
        if MODE == "pushup":
            # Hitung rata-rata sudut lutut kiri dan kanan
